 ...
 *
 */
export class ProjectQueryable extends ODataQueryable<SPBatch> {
    ...
    constructor(baseUrl: string | ProjectQueryable, path?: string) {
        ...
        if (typeof baseUrl === "string") {
            ...
            const q = baseUrl as ProjectQueryable;
 ...
 *
 */
export class ProjectQueryableCollection extends ProjectQueryable {
